                ...
                <Col sm={6}>
                    <Form className="entry-form" horizontal>
                        ...
                        <FormGroup controlId="formHorizontalUsername">
                            ...
                            <Col sm={10}>
                                <input className="form-control" type="text" placeholder="ACME Waterpumps" ref={ref => {this.username = ref}}/>
                            </Col>
                        </FormGroup>
                        ...
                        <FormGroup controlId="formHorizontalEmail">
                            ...
                            <Col sm={10}>
                                <input className="form-control" type="text" style={this.state.validEmail}
                                       placeholder="123 Main St" ref={ref => {this.email = ref}}/>
                            </Col>
                        </FormGroup>
                        <FormGroup controlId="formHorizontalEmail">
                            <Col componentClass={ControlLabel} sm={5}>
                            ...
                            <Col sm={10}>
                                <input className="form-control" type="text" style={this.state.validEmail}
                                       placeholder="" ref={ref => {this.email = ref}}/>
                            </Col>
                        </FormGroup>
                        <FormGroup controlId="formHorizontalPassword">
                            ...
                            <Col sm={10}>
                                <input className="form-control" type="text" placeholder="Smallville" ref={ref => {this.password = ref}}/>
                            </Col>
                        </FormGroup>
