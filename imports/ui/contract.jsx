...
function getSteps() {
    return ['Date', 'Supplier','Receiver','Goods Purchase','Price and Payment','Shipment and Delivery Terms','Delivery Schedule','Packaging', 'Sign'];
}
...
export default compose(getTrackerLoader(reactiveMapper), options)(Contract);