...
contract AgentBOLRegistratorProxy is Owned {

    address public agentBOLRegistrator;
    ...
    function AgentBOLRegistratorProxy(address _agentContract) public {
        agentBOLRegistrator = _agentContract;
    }

    function setAgentBOLRegistrator(address _agentContract) public onlyContractOwner {
        agentBOLRegistrator = _agentContract;
    }

    // Must be overriden in clonable children
    function _target() internal returns(address) {
        return agentBOLRegistrator;
    }
}