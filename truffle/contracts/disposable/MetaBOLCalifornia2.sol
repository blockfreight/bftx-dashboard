...
contract MetaBOLCalifornia2 is MetaBOL {
    ...
    function MetaBOLCalifornia2(address _controller) MetaBOL(_controller) {
        ...
        // Local registry office notifies the title company that the bol
